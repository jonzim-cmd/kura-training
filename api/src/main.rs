...
#[openapi(
    ...
    paths(
        ...
        routes::agent::get_agent_context_section_index,
        routes::agent::get_agent_context_section_fetch,
    ...
    components(schemas(
        ...
        routes::account::UpdateHealthConsentRequest,
        routes::account::UpdateHealthConsentResponse,
        ...
        routes::agent::AgentContextOverflow,
        routes::agent::AgentContextOverflowSection,
        routes::agent::AgentContextSystemContract,
        routes::agent::AgentStartupGate,
        routes::agent::AgentContextSectionIndexEntry,
        routes::agent::AgentContextSectionIndexResponse,
        routes::agent::AgentContextSectionFetchResponse,
        ...
        routes::agent::AgentObservationDraftDismissRequest,
        routes::agent::AgentObservationDraftDismissResponse,
        ...
        routes::agent::AgentBriefSectionFetch,
        routes::semantic::SemanticDomain,
        routes::semantic::SemanticConfidenceBand,
        routes::semantic::SemanticProviderInfo,
        routes::semantic::SemanticCatalogResponse,
        routes::semantic::SemanticCatalogItem,
        routes::semantic::SemanticCatalogMeta,
        ...
        routes::auth::SupabaseRegisterRequest,
        ...
        routes::projections::PaginatedProjectionResponse,
...
async fn main() {
    ...
    let app = Router::new()
        ...
        .merge(
            routes::auth::supabase_register_router()
