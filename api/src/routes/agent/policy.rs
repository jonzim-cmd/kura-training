...
pub(super) const AGENT_CONTEXT_CONTRACT_VERSION: &str = "agent_context.v11.brief_first.overflow_protocol.temporal_grounding.challenge_memory.decision_brief_detail_caps.consent_gate.budgeted_payload";
