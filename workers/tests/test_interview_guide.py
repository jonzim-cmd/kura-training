...
class TestEventConventions:
    ...
    def test_all_tracking_event_types_documented(self):
        ...
        expected = {
            ...
            "meal.logged",
            "supplement.regimen.set", "supplement.regimen.paused",
            "supplement.regimen.resumed", "supplement.regimen.stopped",
            "supplement.taken", "supplement.skipped", "supplement.logged",
