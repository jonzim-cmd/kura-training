  ...
  return (
    <div className={styles.descent}>
      ...
      <section className={styles.surface}>
        <h1 className={styles.surfaceTitle}>KURA</h1>
      </section>
      ...
      <section className={styles.bottom}>
        <div className={styles.bottomInner}>
          <div className={styles.bottomMark}>KURA</div>
  ...
  return (
    <section className={styles.inside} ref={ref}>
      ...
      <svg data-threads className={styles.threadsSvg} viewBox="0 0 1440 2200" preserveAspectRatio="none">
        <line x1="173" y1="264" x2="403" y2="616" stroke="rgba(196,147,90,0.12)" strokeWidth="0.5" />
        <line x1="403" y1="484" x2="648" y2="836" stroke="rgba(196,147,90,0.08)" strokeWidth="0.5" />
        <line x1="648" y1="770" x2="893" y2="1144" stroke="rgba(196,147,90,0.1)" strokeWidth="0.5" />
        <line x1="893" y1="660" x2="1123" y2="990" stroke="rgba(196,147,90,0.06)" strokeWidth="0.5" />
        <line x1="173" y1="990" x2="648" y2="1430" stroke="rgba(196,147,90,0.08)" strokeWidth="0.5" />
        <line x1="1123" y1="1100" x2="893" y2="1650" stroke="rgba(196,147,90,0.1)" strokeWidth="0.5" />
      </svg>
        ...
        <svg viewBox="0 0 1440 1000" fill="none" preserveAspectRatio="xMidYMid slice">
          {[80, 180, 300, 420, 540, 680, 820].map((y, i) => (
            <path
              ...
              stroke={`rgba(232,224,212,${0.06 + (i % 3) * 0.02})`}
              strokeWidth="0.8"
            />
          ))}
          {[173, 403, 648, 893, 1123].map((x, i) => (
            <line key={i} x1={x} y1="0" x2={x} y2="1000" stroke={`rgba(232,224,212,${0.04 + (i % 2) * 0.03})`} strokeWidth="0.5" />
          ))}
          <line x1="173" y1="180" x2="403" y2="300" stroke="rgba(196,147,90,0.06)" strokeWidth="0.4" />
          <line x1="648" y1="300" x2="893" y2="420" stroke="rgba(196,147,90,0.07)" strokeWidth="0.4" />
          <line x1="893" y1="540" x2="1123" y2="680" stroke="rgba(196,147,90,0.05)" strokeWidth="0.4" />
